...
import useUpdateApiTokens from '../../src/views/Auth/hooks/useUpdateApiTokens';
...
describe('useUpdateApiTokens', () => {
  it('should update api tokens', async () => {
    ...
    jest.spyOn(mockLogin, 'useApiTokensClientTracking').mockImplementationOnce(() => [{ payload: { data: { key: "value" } } }]);

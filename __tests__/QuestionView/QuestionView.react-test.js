...
const setup = propOverrides => {
  ...
  const props = Object.assign({
    labels: labels.data,
    hearing: hearingWithSections.mockHearingWithSections,
    match: {
      params: {
  ...
  const wrapper = shallow(<MemoryRouter><QuestionView intl={getIntlAsProp()} {...props} /></MemoryRouter>);
...
test('QuestionView component should render as expected', () => {
  const {wrapper} = setup();

...
const config = {
  ...
  sentryTracesSampleRate: parseFloat(window._env_.REACT_APP_SENTRY_TRACES_SAMPLE_RATE) || 0,
  sentryTracePropagationTargets: (window._env_.REACT_APP_SENTRY_TRACE_PROPAGATION_TARGETS || '').split(','),
  sentryReplaysSessionSampleRate: parseFloat(window._env_.REACT_APP_SENTRY_REPLAYS_SESSION_SAMPLE_RATE) || 0,
  sentryReplaysOnErrorSampleRate: parseFloat(window._env_.REACT_APP_SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE) || 0,

...
class CookieManagementModal extends React.Component {
  ...
  render() {
    return (
      <Modal className='cookie-management-modal' size='xl' show={this.props.isOpen} onHide={() => this.handleOnHide()}>
        <Modal.Body>
          <Button id='cookie-management-modal-close' onClick={() => this.props.close()}>
            <Icon name='close' />
          </Button>
          <Modal.Title>
            <FormattedMessage id='cookieBar.modal.header' />
          </Modal.Title>
                ...
                <Panel.Title>
                  <div id='cookie-panel-title-container'>
                    <div
                      ...
                      onKeyDown={(ev) => this.handleKeyDown(ev, 'activeKey', this.state.activeKey === '1' ? '0' : '1')}
                    >
                      <Icon
                ...
                <Panel.Title>
                  <div id='cookie-panel-title-container'>
                    <div
                      ...
                      onKeyDown={(ev) => this.handleKeyDown(ev, 'activeKey', this.state.activeKey === '2' ? '0' : '2')}
                    >
                      <Icon
                        id='cookie-panel-icon'

...
describe('validateFunction', () => {
  ...
  describe('title validation', () => {
    it('returns true if one or more of the titles is empty', () => {
    ...
    it('return false if none of the titles are empty', () => {
  ...
  describe('labels validation', () => {
    it('returns true/false based on if hearingLabels array is empty', () => {
      expect(validationFunction.labels([])).toBe(true);
    });

    it('returns false if hearingLabels array is not empty', () => {
      expect(validationFunction.labels([{}])).toBe(false);
    });
  });

  describe('slug validation', () => {
    it('return true if hearingSlug is an empty string', () => {
      expect(validationFunction.slug('')).toBe(true);
    });

    it('return false if hearingSlug is not an empty string', () => {
      expect(validationFunction.slug(mockHearing.data.slug)).toBe(false);
    });
  });

  describe('contact persons validation', () => {
    it('return true if contactPersons array is empty', () => {
  ...
  describe('open at validation', () => {
    it('return true if prop is false', () => {
  ...
  describe('project validation', () => {
    describe('project exists validation', () => {
      it('return true if project is not empty', () => {
        expect(validationFunction.project({ id: '11' })).toBe(true);
      });

      it('return false if project is empty', () => {
    ...
    describe('project phases active validation', () => {
      ...
      it('return true if none of the phases are active', () => {
        expect(validationFunction.project_phases_active(phases)).toBe(true);
      });

      it('return false if one of the phases are active', () => {
